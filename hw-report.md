...
| --------------------|:-------------------:|:------------:|:------------:|:------------:|:------------:|:------------:|:----------------|-------------------------:|
| размер асм-файла    | 17 814 байт         | 17 814 байт  | 16 502 байт  | 18 193 байт  | 23 609 байт  | 15 408 байт  | 22 669 байт     | ... байт              |
...
| --------------------|:-------------------:|:------------:|:------------:|:------------:|:------------:|:------------:|:----------------|-------------------------:|
| размер асм-файла    | 17 814 байт         | 17 814 байт  | 16 502 байт  | 18 193 байт  | 23 609 байт  | 15 408 байт  | 22 669 байт     | ... байт                 |
| размер i-файла      | 250 892 байт        | 250 892 байт | 330 348 байт | 330 348 байт | 330 348 байт | 316 008 байт | 334 548 байт    | ... байт                 |
| размер o-файла      | 15 080 байт         | 15 080 байт  | 15 752 байт  | 16 000 байт  | 17 640 байт  | 15 184 байт  | 17 232 байт     | ... байт                 |
| размер испол. файла | 17 104 байт         | 17 104 байт  | 17 136 байт  | 17 136 байт  | 21 232 байт  | 17 128 байт  | 21 272 байт     | ... байт                 |
| время работы        | 74 049.8 ns         | 68 888.2 ns  | 58 068.4 ns  | 49 228.2 ns  | 54 890.8 ns  | 39 730.8 ns  | 47 138.7 ns     | ... ns                   |
<br>
