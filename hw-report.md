...
2. 
3. Для передачи параметров могут использоваться регистры: XMM0, XMM1, XMM2, XMM3, XMM4, XMM5, XMM6, XMM7    (аргументы с 1-го по 8-й соот-но) 
4. Для передачи FP-параметров могут использоваться регистры: XMM0, XMM1, XMM2, XMM3.

XMM0-XMM7 для 32-битного Protected Mode
XMM8-XMM15 для режима 64-битного Long Mode.

6. 
7. Комментарии поясняют использование регистров (см. комментарии в п.7. Тексты программы на языке ассемблера)
8. Представлены тестовые прогоны (см. п.4-5 Тесты и результаты прогонов)
9. Представлено сравнение результатов скомпилированной программы и измененной (см. критерий на 9)
